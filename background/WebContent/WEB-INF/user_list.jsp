...
<div class="page-content clearfix">
    ...
    <div class="search_style">
      ...
      <ul class="search_content clearfix">
       <li><label class="l_f">会员名称</label><input name="" type="text"  class="text_add"  id="searchAll" placeholder="输入会员名称、电话、邮箱"  style=" width:400px"/></li>
	...
	<c:forEach items="${userList}" var="user">
		<tr>
          ...
          <td>${user.id}</td>
          <td><u style="cursor:pointer" class="text-primary" onclick="member_show('${user.name}','memberShow.do?id=${user.id}','10001','500','400')">${user.user}</u></td>
          <td>男</td>
          <td>${user.phone}</td>
...
$(".btn_search").click(function() {
	var name=$("#searchAll").val();
	location.href="showUserlist.do?name="+name;
})
</script>