...
<body>
	<div id="main">
		...
		<form action="emp" method="post" class="form-horizontal" />
		...
		<div id="fy">
			<ul class="pagination">
				<li><a
					href="emp?ye=1&name=${c.name}&sex=${c.sex}&age=${c.age!=-1?c.age:''}&d_id=${c.dep.id!=-1?c.dep.id:''}">&laquo;首页</a></li>
				<li id="pre"><a
					href="emp?ye=${p.ye-1}&name=${c.name}&sex=${c.sex}&age=${c.age!=-1?c.age:''}&d_id=${c.dep.id!=-1?c.dep.id:''}">&laquo;上一页</a></li>
				<c:forEach begin="${p.beginYe}" end="${p.endYe}" varStatus="status">
					<li <c:if test="${p.ye==status.index}">class="active"</c:if>><a
						href="emp?ye=${status.index}&name=${c.name}&sex=${c.sex}&age=${c.age!=-1?c.age:''}&d_id=${c.dep.id}">${status.index}</a></li>
				</c:forEach>
				<li id="next"><a
					href="emp?ye=${p.ye+1}&name=${c.name}&sex=${c.sex}&age=${c.age!=-1?c.age:''}&d_id=${c.dep.id!=-1?c.dep.id:''}">下一页&raquo;</a></li>
				<li><a
					href="emp?ye=${p.maxYe}&name=${c.name}&sex=${c.sex}&age=${c.age!=-1?c.age:''}&d_id=${c.dep.id!=-1?c.dep.id:''}">末页&raquo;</a></li>
			</ul>
		</div>
		<div>
