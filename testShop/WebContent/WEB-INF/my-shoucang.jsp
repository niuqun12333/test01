			...
			<div class="member-border">
				...
				<div class="member-return H-over">
					<div class="member-troll clearfix">
						<div class="member-all fl">
							<b class="on"></b>全选
						</div>
						<div class="member-check clearfix fl">
							<a href="#" class="member-delete">删除商品</a>
						</div>
					</div>
						...
						<ul>
							<li class="clearfix">
								<div class="member-tenant fl clearfix">
									<div class="fl member-all1 member-all2">
										<b class="on"></b>
									</div>
									<div class="fr">
										<a href="#"><img src="images/shangpinxiangqing/X-1.png"
											title="" width="114" height="114"></a>
										<p>秋水伊人官方旗舰店</p>
										<p>
											<a href="#" class="member-shops">进入店铺</a>
										</p>
										<p>关注人气：1000+</p>
										<p>收藏时间：2014-11-21</p>
									</div>
								...
								<div class="member-volume fl">
									...
									<div class="member-cakes fl">
										<ul>
											<li><a href="#"><img
													src="images/shangpinxiangqing/X-1.png" title="" width="125"
													height="125"></a>
												<p>￥78.00</p></li>
											<li><a href="#"><img
													src="images/shangpinxiangqing/X-1.png" title="" width="125"
