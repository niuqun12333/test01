							...
							<c:forEach items="${list}" var="order">
								<li>
									<div class="member-minute clearfix">
										<span>${order.time}</span> <span>订单号：<em>${order.orderNum}</em></span>
										<span><a href="#">以纯甲醇旗舰店</a></span> <span
											class="member-custom">客服电话：<em>010-6544-0986</em></span>
									</div>
									<div class="member-circle clearfix">
										<div class="ci1">
											<c:forEach items="${order.details}" var="detail">
												<div class="ci7 clearfix">
													<span class="gr1"><a href="#"><img src="pic/${detail.product.pictures[0].path}"
															title="" about="" width="60" height="60"></a></span> <span
														class="gr2"><a href="#">${detail.product.name}</a></span> <span class="gr3">X${detail.num}</span>
												</div>
											</c:forEach>
										</div>
										<div class="ci2">${order.location.name}</div>
										<div class="ci3">
											<b>￥${order.total}</b>
											<p>货到付款</p>
										...
										<div class="ci5 ci8">
											<p>
												<a href="#">查看</a> | <a href="deleteOrder.do?id=${order.id}">删除</a>
											</p>
											<p></p>
											<p>
				...
				<div class="member-return H-over" style="display: none;">
					...
					<div class="member-sheet clearfix">
						<ul>
							<li>
								<div class="member-minute clearfix">
									<span>2015-09-22 18:22:33</span> <span>订单号：<em>98653056821</em></span>
									<span><a href="#">以纯甲醇旗舰店</a></span> <span
										class="member-custom">客服电话：<em>010-6544-0986</em></span>
								</div>
								<div class="member-circle clearfix">
									<div class="ci1">
										<div class="ci7 clearfix">
											<span class="gr1"><a href="#"><img
													src="../theme/img/pd/m1.png" title="" about="" width="60"
													height="60"></a></span> <span class="gr2"><a href="#">红米Note2
													标准版 白色 移动4G手机 双卡双待</a></span> <span class="gr3">X1</span>
										</div>
										<div class="ci7 clearfix">
											<span class="gr1"><a href="#"><img
													src="../theme/img/pd/m2.png" title="" about="" width="60"
													height="60"></a></span> <span class="gr2"><a href="#">AXON天机mini
													NBA限量版</a></span> <span class="gr3">X9</span>
										</div>
									</div>
